<img width="2698" height="1810" alt="image" src="https://github.com/user-attachments/assets/4dd31b60-e436-460f-a600-32b6e6609bec" />
...
package "Основной контекст" <<Main>> {
  ...
  interface IGrantRepository <<Interface>> {
    ...
    + sumAmount(): double
    + avgAmountByInvestor(investorId): double
    + getInvestorStats(InvestorId): int
  }
