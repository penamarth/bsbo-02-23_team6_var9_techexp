<img width="2108" height="1708" alt="image" src="https://github.com/user-attachments/assets/64e519c7-5fbd-49ec-8faa-c9774b5285c3" />
...
package "Основной контекст" <<Main>> {
  ...
  class GrantSystemFacade <<Facade>> {
    ...
    ' Заявки
    + createApplication(applicationData: GrantApplicationDTO): GrantApplication
  ...
  interface IAppRepository <<Interface>> {
    ...
    + update(GrantApplicationData): GrantApplication
  }
