<img width="1122" height="1473" alt="image" src="https://github.com/user-attachments/assets/26a16e6c-504f-488f-a994-a4d7b6f169d6" />
...
StatsService -> UserRepo : getReviews(123)
activate StatsService
UserRepo --> StatsService : reviews=28

StatsService -> UserRepo : getAvgScore(123)
activate StatsService
UserRepo --> StatsService : avgScore=7.8
...
StatsService -> AppRepo: getInvestorGrants(456)
activate StatsService
AppRepo--> StatsService : grants=15

StatsService -> AppRepo: getInvestorTotal(456)
activate StatsService
AppRepo--> StatsService : total=1250000
